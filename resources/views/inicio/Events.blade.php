...
<!--float label-->
<link href={{ URL::asset("css/style.css") }} rel="stylesheet"><!--[if lt IE 9]>
		...
		<article class="pad_left2">
			...
			<div class="wrapper marg_top">
				...
				<article class="col3 pad_left1">
					...
					<p><strong>Nemo enim ipsam</strong><br>	Voluptatem quia voluptas sit aspernatur aut odit aut fugit, <br>sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci <br>velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam.</p>
				</article>
				<article class="col3 pad_left1">
					<figure><img src="images/page4_img4.jpg" alt="" class="pad_bot1"></figure>
					<p><strong>Veque porro quisquam est</strong><br>Qui dolorem ipsum quia dolor <br>sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam.quaerat voluptatem.<br>Ut enim ad minima veniam, <br>quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex <br>ea conon numquammmodi consequatur.</p>
				</article>
				<article class="col3 pad_left1">
